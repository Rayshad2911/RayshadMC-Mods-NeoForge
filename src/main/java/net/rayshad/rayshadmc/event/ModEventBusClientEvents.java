...
import net.rayshad.rayshadmc.renderer.ModHangingSignBlockEntityRenderer;
...
public class ModEventBusClientEvents {
    ...
    public static void registerBER(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.MOD_HANGING_SIGN.get(), ModHangingSignBlockEntityRenderer::new);
    }
}
